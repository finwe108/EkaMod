...
class Sf1ExportService
{
    ...
    protected function fillHeader(Worksheet $sheet, array $meta): void
    {
    ...
    protected function fillStudentBlock(Worksheet $sheet, array $students, int $startRow, int $endRow): void
    {
    ...
    protected function fillSummary(Worksheet $sheet, array $meta, array $maleStudents, array $femaleStudents): void
    {
