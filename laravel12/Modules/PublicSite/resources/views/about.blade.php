...
<section class="story-hero">
    <div class="container story-hero__inner">
        <p class="eyebrow">About {{ $shortName }}</p>
        <h1>About {{ $schoolName }}</h1>
...
<section class="section">
    <div class="container split">
        ...
        <div class="rich-copy">
            <p>
                {{ $schoolName }} is a private, non-sectarian, pro-life institution committed
    ...
    <div class="container split">
        ...
        <div class="rich-copy">
            <p>
                ...
                {{ $schoolName }} continues to expand and evolve to meet the needs of modern learners.
            </p>
        </div>
    </div>
</section>
