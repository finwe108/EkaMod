<div class="topbar">
    <div class="container topbar__inner">
        <div class="topbar__contact">
            <a href="tel:{{ config('school.phone') }}" data-icon="phone">
                {{ config('school.phone') }}
            </a>

            <a href="mailto:{{ config('school.email') }}" data-icon="mail">
                {{ config('school.email') }}
            </a>
        </div>
...
<header class="site-header" data-header>
    <div class="container header__inner">
        ...
        <a class="brand" href="{{ route('public.home') }}#home" aria-label="{{ config('school.name') }} home">
            ...
            <span>
                ...
                <small>{{ config('school.tagline') }}</small>
            </span>
        </a>
