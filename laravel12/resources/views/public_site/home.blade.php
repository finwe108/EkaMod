...
@section('title', config('school.short') . ' | Admissions and Campus Life')
...
<section class="hero" id="home">
    ...
    <div class="container hero__content">
        <div class="hero__seal" aria-hidden="true">
            <img src="{{ asset('assets/images/mmci-logo.png') }}" alt="">
        </div>
...
<section class="section section--split" id="about">
    <div class="container split">
        ...
        <div class="rich-copy">
            <p>
                {{ config('school.name') }} serves learners in Kibawe and neighboring municipalities
...
<section class="section section--contact" id="contact">
    <div class="container contact">
        ...
        <div class="contact__links">
            <a href="tel:{{ config('school.phone') }}">{{ config('school.phone') }}</a>
            <a href="mailto:{{ config('school.email') }}">{{ config('school.email') }}</a>
