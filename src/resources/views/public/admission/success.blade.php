...
@section('title', 'Application Submitted | ' . config('school.name'))
    ...
    <div class="container" style="max-width: 760px;">
        ...
        <div id="application-slip" style="background:#fff; border:1px solid #ddd; border-radius:10px; padding:24px;">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
                <div>
                    <strong>{{ config('school.name') }}</strong><br>
                    <small>{{ config('school.address') }}</small>
                </div>
                <img src="{{ asset('assets/images/mmci-logo.png') }}" width="60">
            </div>
