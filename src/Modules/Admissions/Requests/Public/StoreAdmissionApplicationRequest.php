...
namespace Modules\Admissions\Requests\Public;

use Illuminate\Foundation\Http\FormRequest;

/**
 * Handles validation for public admission application submissions.
 *
 * This request preserves the existing public admission validation rules
 * from the original monolith implementation.
 *
 * Module: Admissions
 * Layer: Request
 */
