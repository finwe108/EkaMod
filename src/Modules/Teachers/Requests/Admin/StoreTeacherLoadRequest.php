...
/**
 * Handles validation for creating teacher loads.
 *
 * This request preserves the existing teacher load validation behavior,
 * including schedule time validation, internal schedule conflict checking,
 * and teacher/section conflict detection.
 *
 * Module: Teachers
 * Layer: Request
 */
class StoreTeacherLoadRequest extends FormRequest
{
    /**
    ...
    /**
     * Get validation rules for creating teacher loads.
     *
