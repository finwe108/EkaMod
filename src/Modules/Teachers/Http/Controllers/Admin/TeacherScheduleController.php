...
/**
 * Handles administrative teacher schedule viewing.
 *
 * This controller displays a weekly schedule matrix and schedule list
 * for a selected teacher.
 *
 * Existing URL and route name are preserved:
 * /admin/teachers/{teacher}/schedule
 * admin.teachers.schedule
 *
 * Module: Teachers
...
{
    /**
     * Display a teacher's schedule for a selected school year.
     *
    ...
    public function show(Request $request, Teacher $teacher): View
    {
        ...
        return view('teachers::admin.teachers.schedule', compact(
            'teacher',
            'schoolYears',
            'activeSchoolYear',
            'schoolYearId',
